...
const Help1: React.FC = () => {
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <ThemedText style={styles.stepText}>Step 01</ThemedText>
      
      <ThemedText style={styles.instructionText}>
        image should be above chest{'\n'}or head with shoulder.
      </ThemedText>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity onPress={() => router.push('/help_2')}>
